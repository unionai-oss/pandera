...
docs-clean:
	rm -rf docs/source/refernce/generated docs/**/generated docs/**/methods docs/_build docs/source/_contents

docs: docs-clean
	python -m sphinx -vvv -W -E "docs/source" "docs/_build" && make -C docs doctest
