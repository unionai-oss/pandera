...
@pytest.mark.xfail(condition=narwhals_installed, reason="Ibis-style check functions incompatible with Narwhals backend", strict=True)
...
@pytest.mark.xfail(condition=narwhals_installed, reason="Element-wise checks incompatible with Narwhals backend", strict=True)
