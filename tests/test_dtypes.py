...
@pytest.mark.parametrize(
    ...
    [
        ...
        (np.float_, _DEFAULT_NUMPY_FLOAT_TYPE),
        (np.float16, _DEFAULT_NUMPY_FLOAT_TYPE),
        (np.float32, _DEFAULT_NUMPY_FLOAT_TYPE),
        (np.float64, _DEFAULT_NUMPY_FLOAT_TYPE),
        # Pandas always converts int numbers to default numpy type
        (np.int_, _DEFAULT_NUMPY_INT_TYPE),
        (np.int_, _DEFAULT_NUMPY_INT_TYPE),
        (np.int8, _DEFAULT_NUMPY_INT_TYPE),
        (np.int16, _DEFAULT_NUMPY_INT_TYPE),
        (np.int32, _DEFAULT_NUMPY_INT_TYPE),
        (np.int64, _DEFAULT_NUMPY_INT_TYPE),
