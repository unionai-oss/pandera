...
_NARWHALS_INCOMPATIBLE_POLARS_DTYPE_CLASSES = (
    pl.Binary,
    pl.Categorical,
    pl.Decimal,
    pl.Time,
...
def _is_narwhals_incompatible_polars_dtype(dtype):
    if isinstance(dtype, type):
        return issubclass(dtype, _NARWHALS_INCOMPATIBLE_POLARS_DTYPE_CLASSES)
    return isinstance(dtype, _NARWHALS_INCOMPATIBLE_POLARS_DTYPE_CLASSES)
