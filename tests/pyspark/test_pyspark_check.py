...
def test_datatype_check_decorator(spark):
    ...
    try:
        ...
        assert err.__str__() == "The check with name \"str_startswith\" only supports the following datatypes ['string'] and not the given \"integer\" datatype"
...
class BaseClass:
    ...
    sample_string_data = {"test_pass_data": [("foo", "b"), ("bar", "c")],
                          "test_expression": "a"}

    sample_array_data = {"test_pass_data": [("foo", ["a"]), ("bar", ["a"])],
                          "test_expression": "a"}

    sample_map_data = {"test_pass_data": [("foo", {"a":"a"}), ("bar", {"b":"b"})],
                          "test_expression": "b"}

    sample_bolean_data = {"test_pass_data": [("foo", True), ("bar", True)],
    ...
    def check_function(spark, check_fn, pass_case_data,
                       fail_case_data, data_types, function_args, skip_fail_case=False):
        schema = DataFrameSchema(
            {
                "product": Column(StringType()),
...
class TestEqualToCheck(BaseClass):
    ...
    sample_string_data = {"test_pass_data": [("foo", "a"), ("bar", "a")],
    ...
    def get_data_param(self):
       return {"test_equal_to_check": [{"datatype": LongType(), "data": self.sample_numeric_data},
         ...
         "test_failed_unaccepted_datatypes": [{"datatype": ArrayType(StringType()), "data": self.sample_array_data},
                                              {"datatype": MapType(StringType(), StringType()), "data": self.sample_map_data}]}
    ...
    def test_equal_to_check(self, spark, check_fn, datatype, data) -> None:
        ...
        self.check_function(spark, check_fn, data['test_pass_data'], data['test_fail_data'],
    ...
    def test_failed_unaccepted_datatypes(self, spark, check_fn, datatype, data) -> None:
        ...
        with pytest.raises(TypeError):
            self.check_function(spark, check_fn, data['test_pass_data'], None,
                                datatype, data['test_expression'])
...
class TestNotEqualToCheck(BaseClass):
    ...
    sample_numeric_data = {"test_pass_data": [("foo", 31), ("bar", 32)],
                           "test_fail_data": [("foo", 30), ("bar", 31)],
                           "test_expression": 30}
    ...
    def get_data_param(self):
       return {"test_not_equal_to_check": [{"datatype": LongType(), "data": self.sample_numeric_data},
         {"datatype": IntegerType(), "data": self.sample_numeric_data},
         {"datatype": ByteType(),  "data": self.sample_numeric_data},
         {"datatype": ShortType(),  "data": self.sample_numeric_data},
         {"datatype": StringType(), "data": self.sample_string_data},
...
class TestGreaterThanCheck(BaseClass):
    ...
    sample_timestamp_data = {"test_pass_data": [("foo", datetime.datetime(2020, 10, 1, 11, 0)),
                                                                  ("bar",  datetime.datetime(2020, 10, 2,  11, 0))],
                                               "test_fail_data": [("foo",  datetime.datetime(2020, 10, 1,  10, 0)),
                                                                  ("bar",  datetime.datetime(2020, 10, 2,  11, 0))],
                                               "test_expression": datetime.datetime(2020, 10, 1,  10, 0)
                             }
    sample_date_data = {"test_pass_data": [("foo", datetime.date(2020, 10, 2)),
    ...
    def get_data_param(self):
       return {"test_greater_than_check": [{"datatype": LongType(), "data": self.sample_numeric_data},
         {"datatype": IntegerType(), "data": self.sample_numeric_data},
         {"datatype": ByteType(),  "data": self.sample_numeric_data},
         {"datatype": ShortType(),  "data": self.sample_numeric_data},
         {"datatype": DoubleType(),"data":
         ...
         "test_failed_unaccepted_datatypes": [{"datatype": StringType(), "data": self.sample_string_data},
                                              {"datatype": BooleanType(), "data": self.sample_bolean_data},
...
class TestGreaterThanEqualToCheck(BaseClass):
    ...
    def get_data_param(self):
       return {"test_greater_than_or_equal_to_check": [{"datatype": LongType(), "data": self.sample_numeric_data},
         {"datatype": IntegerType(), "data": self.sample_numeric_data},
         {"datatype": ByteType(),  "data": self.sample_numeric_data},
         {"datatype": ShortType(),  "data": self.sample_numeric_data},
         {"datatype": DoubleType(),"data":
    ...
    @pytest.mark.parametrize("check_fn", [pa.Check.greater_than_or_equal_to, pa.Check.ge])
    def test_greater_than_or_equal_to_check(self, spark, check_fn, datatype, data) -> None:
        """Test the Check to see if all the values are equal to defined value"""
        self.check_function(spark, check_fn, data['test_pass_data'], data['test_fail_data'],
                            datatype, data['test_expression'])
...
class TestLessThanCheck(BaseClass):
    ...
    def get_data_param(self):
       return {"test_less_than_check": [{"datatype": LongType(), "data": self.sample_numeric_data},
         {"datatype": IntegerType(), "data": self.sample_numeric_data},
         {"datatype": ByteType(),  "data": self.sample_numeric_data},
         {"datatype": ShortType(),  "data": self.sample_numeric_data},
         {"datatype": DoubleType(),"data":
...
class TestLessThanOrEqualToCheck(BaseClass):
    ...
    sample_numeric_data = {"test_pass_data": [("foo", 31), ("bar", 33)],
    ...
    def get_data_param(self):
       return {"test_less_than_or_equal_to_check": [{"datatype": LongType(), "data": self.sample_numeric_data},
         {"datatype": IntegerType(), "data": self.sample_numeric_data},
         {"datatype": ByteType(),  "data": self.sample_numeric_data},
         {"datatype": ShortType(),  "data": self.sample_numeric_data},
         {"datatype": DoubleType(),"data":
...
class TestIsInCheck(BaseClass):
    ...
    sample_date_data = {"test_pass_data": [("foo", datetime.date(2020, 10, 1)),
    ...
    def get_data_param(self):
       return {"test_isin_check": [{"datatype": LongType(), "data": self.sample_numeric_data},
         {"datatype": IntegerType(), "data": self.sample_numeric_data},
         {"datatype": ByteType(),  "data": self.sample_numeric_data},
         {"datatype": ShortType(),  "data": self.sample_numeric_data},
         {"datatype": DoubleType(),"data":
         ...
         "test_failed_unaccepted_datatypes": [{"datatype": BooleanType(), "data": self.sample_bolean_data},
                                              {"datatype": ArrayType(StringType()), "data": self.sample_array_data},
                                              {"datatype": MapType(StringType(), StringType()), "data": self.sample_map_data}]}
    ...
    def test_isin_check(self, spark, datatype, data) -> None:
        """Test the Check to see if all the values are equal to defined value"""
        self.check_function(spark, pa.Check.isin, data['test_pass_data'], data['test_fail_data'],
                            datatype, data['test_expression'])

    def test_failed_unaccepted_datatypes(self, spark, datatype, data) -> None:
        """Test the Check to see if all the values are equal to defined value"""
        with pytest.raises(TypeError):
            self.check_function(spark, pa.Check.isin, data['test_pass_data'], None,
                                datatype, data['test_expression'])
...
class TestNotInCheck(BaseClass):
    ...
    def get_data_param(self):
       return {"test_notin_check": [{"datatype": LongType(), "data": self.sample_numeric_data},
         {"datatype": IntegerType(), "data": self.sample_numeric_data},
         {"datatype": ByteType(),  "data": self.sample_numeric_data},
         {"datatype": ShortType(),  "data": self.sample_numeric_data},
         {"datatype": DoubleType(),"data":
    ...
    def test_notin_check(self, spark, datatype, data) -> None:
        ...
        self.check_function(spark, pa.Check.notin, data['test_pass_data'], data['test_fail_data'],
                            datatype, data['test_expression'])

    def test_failed_unaccepted_datatypes(self, spark, datatype, data) -> None:
        """Test the Check to see if all the values are equal to defined value"""
        with pytest.raises(TypeError):
            self.check_function(spark, pa.Check.notin, data['test_pass_data'], None,
                                datatype, data['test_expression'])
...
def test_str_startswith_check(spark) -> None:
    ...
    BaseClass.check_function(spark, check_func, pass_data, fail_data,
...
class TestInRangeCheck(BaseClass):
    ...
    def get_data_param(self):
        param_vals = [{"datatype": LongType(), "data": self.sample_numeric_data},
                      {"datatype": IntegerType(), "data": self.sample_numeric_data},
                      {"datatype": ByteType(), "data": self.sample_numeric_data},
                      {"datatype": ShortType(), "data": self.sample_numeric_data},
                      {"datatype": DoubleType(), "data":
        ...
        return {"test_inrange_exclude_min_max_check": param_vals,
    ...
    def test_inrange_exclude_min_max_check(self, spark, datatype, data) -> None:
        ...
        self.check_function(spark, pa.Check.in_range, data['test_pass_data'], data['test_fail_data'],
                            datatype, (min_val-add_value, max_val+add_value, False, False))

    def test_inrange_exclude_min_only_check(self, spark, datatype, data) -> None:
        """Test the Check to see if any value is not in the specified value"""
        min_val, max_val, add_value = self.create_min_max(data)
        self.check_function(spark, pa.Check.in_range, data['test_pass_data'], data['test_fail_data'],
                            datatype,  (min_val, max_val+add_value, True, False))
    def test_inrange_exclude_max_only_check(self, spark, datatype, data) -> None:
        """Test the Check to see if any value is not in the specified value"""
        min_val, max_val, add_value = self.create_min_max(data)
        self.check_function(spark, pa.Check.in_range, data['test_pass_data'], data['test_fail_data'],
                            datatype, (min_val-add_value, max_val, False, True))

    def test_inrange_include_min_max_check(self, spark, datatype, data) -> None:
        """Test the Check to see if any value is not in the specified value"""
        min_val, max_val, add_value = self.create_min_max(data)
        self.check_function(spark, pa.Check.in_range, data['test_pass_data'], data['test_fail_data'],
                            datatype, (min_val, max_val, True, True))

    def test_failed_unaccepted_datatypes(self, spark, datatype, data) -> None:
        """Test the Check to see if all the values are equal to defined value"""
        with pytest.raises(TypeError):
            self.check_function(spark, pa.Check.in_range, data['test_pass_data'], None,
                                datatype, data['test_expression'])
