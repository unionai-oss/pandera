...
def to_script(
    ...
    *,
    ...
    :param minimal: If True (default), omit constructor-default kwargs in the
        generated ``Column`` / ``DataFrameSchema`` / ``Field`` calls.
    :param script_type: ``\"schema\"`` emits ``DataFrameSchema`` (default).
        ``\"model\"`` emits a :class:`~pandera.api.dataframe.model.DataFrameModel`
        subclass for the pandas API.
    :returns: script string if ``path_or_buf`` is None, otherwise None.
    """
